...
Relações:
    ...
    Encomenda é fornecida por Fornecedor;
    Produto é um item de uma Encomenda;
    Armazém tem Produtos;
...
```
Cada Fornecedor não pode existir sem um, e só um, Tipo de Fornecedor;
Cada encomenda não pode existir sem um, e só um, Fornecedor;
Não existem encomendas sem produtos, cada encomenda pode ter vários produtos diferentes, cada produto pode fazer parte de várias encomendas;
Não existem armazéns sem produtos, cada armazém pode ter vários produtos diferentes, cada produto pode fazer parte de vários produtos;
